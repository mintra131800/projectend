                                ...
                                <View style={{
                                    ...
                                    <View style={{ width: '100%', flexDirection: 'row' }}>
                                        ...
                                        <View>
                                            ...
                                            <View style={{ flexDirection: 'row', borderRadius: 15, width: 100, height: 30, backgroundColor: '#28821F', marginTop: 5, marginLeft: 10 }}>
                                                <Icon name={'caret-up'} size={20} color={'grenn'} style={{ margin: 5 }} />
                                                <Text style={{ textAlign: 'center', margin: 5, color: 'green' }}>{item.text} bath</Text>
                                            </View>
                                        </View>
